...
namespace GUI_EXCEL_parser
{
    public partial class Converter : Form
    {
        ...
        private void InitializeCustomComponents()
        {
            ...
            this.btnCreateSecondDatabase.BackColor = System.Drawing.Color.LightCoral;
        ...
        private async void btnConvert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Восстановление текста и состояния кнопки
        ...
        static StringBuilder GenerateCsvContent(List<string> KKSIds, string cabinetName, string controllerIp)
        {
            ...
            foreach (string name in KKSIds)
            {
                ...
                if (model != "AKKUYU_NO_MODEL")
                {
                    ...
                    csvContent.AppendLine($"{cabinetName},{kksnumber},{kksname},DB_HMI_IO_Mechanisms.Devices.Devices[{kksnumber}].OPRT.OPRT_INDEX,Uint,IO,FALSE,COV,pollGr_3,{model},OPRT_INDEX,,,,,,,,,,,,,,,,,TRUE,TRUE,SmoothingConfig_01,,,,,,,,DriverFail,\\{buildingnumber}\\Mechanisms\\{cabinetName}\\,");
        ...
        // Метод для чтения данных о шкафах и их IP
                            ...
                            var tags = new List<Tuple<string, string>>()
                    {
                        ...
                        new Tuple<string, string>("RASU_bits1", "bool")
                            ...
                            foreach (var tag in tags)
                            {
                                ...
                                int counter = 1;
                                while (existingIdx.Contains(idx1) || await IdxExistsAsync(connection, idx1))
                                {
